...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("=".repeat(75) + "\n"
                + "                       Bienvenido al centro de Planes\n");

        while (bandera) {
            System.out.print("=".repeat(75) + "\n"
                    + "  Ingrese '1' para ingresar un Plan de tipo "
            ...
            if ("1".equals(opcion) || "2".equals(opcion)
                    || "3".equals(opcion) || "4".equals(opcion)) {
                System.out.print("=".repeat(75) + "\n");
                ...
                if (opcion.equals("1")) {
                    ...
                    PlanPostPagoMinutos p = new PlanPostPagoMinutos(nombres,
                            apellidos, pasaporte, barrio, marca,
                            modelo, numero);
                    ...
                    PlanPostPagoMinutosMegas p = new PlanPostPagoMinutosMegas(
                            nombres, apellidos, pasaporte, barrio,
                            marca, modelo, numero);
            ...
            System.out.print("=".repeat(75) + "\n"
                    + "  Si desea solicitar otro plan, ingrese 'si':\n  > ");
